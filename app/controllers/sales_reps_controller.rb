class SalesRepsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sales_rep.save
        ...
        format.json { render :show, status: :created, location: @sales_rep }
      else
  ...
  def update
    respond_to do |format|
      if @sales_rep.update(sales_rep_params)
        ...
        format.json { render :show, status: :ok, location: @sales_rep }
      else
  ...
  def destroy
    @sales_rep.destroy
    respond_to do |format|
      format.html { redirect_to sales_reps_url, notice: 'Sales rep was successfully destroyed.' }
